...
<head>
  ...
  <!-- if the presence or absence makes no discernible difference, it is not part of the whole -->
  ...
  <div class="main-content">
    ...
    <div class="content-box blue" onclick="window.location='/info';">
      ...
      <div class="info-txt">
        ...
        3pm-11pm cst</b><br>
        <sub>(hours may vary)</sub>
      </div>
      <div class="since-txt"><i>since 1995</i></div>
      <div class="bg-gradient"></div>
    </div>

    <div class="content-box red" onclick="window.location='/films';">
      <div class="lower-bar" style="text-align:right;">
        <span class="txt">Films</span>
      </div>

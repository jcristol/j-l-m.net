...
<body id="films">
  ...
  <div class="main-content">
    ...
    <div class="top-bar">We Are Texo</div><!-- - - - - - - - - - - - - - - FILM TITLE-->
      ...
      <div class="film-box_large">
        ...
        <div class="main-film">
          ...
          <div class="overlay-info">
            <div class="summary">
              <span class="txt">
                Overview and highlights of the Texo Association members.
              </span>
            </div>
            <div class="crew">
              <table>
                <tr style="background-color:#f2f2f2;">
                  <td class="gray">Directed by</td>
                  <td>Jake Martinez</td>
                </tr>
                <tr>
                  <td class="gray">Produced by</td>
                  <td>Kelsey Cornillie<br>Aubry Malis</td>
                </tr>
                <tr style="background-color:#f2f2f2;">
                  <td class="gray">Written by</td>
                  <td>Jeff Bills</td>
                </tr>
                <tr>
                  <td class="gray">Photography by</td>
                  <td>Jake Martinez</td>
                </tr>
              </table>
            </div>
      ...
      <div class="film-info">
        ...
        <div class="crew">
          <table>
            ...
            <tr>
              <td class="gray">Produced by</td>
              <td>Kelsey Cornillie</td><td></td><td>Aubry Malis</td>
            </tr>
            <tr style="background-color:#f2f2f2;">
              <td class="gray">Written by</td>
              <td>Jeff Bills</td>
